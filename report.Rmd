...
**Meet the Manhattan Foodie Group!**
<br>
...
The Shiny application available [HERE](https://katherinewang0903.shinyapps.io/shinyapp/) offers an interactive platform for users to explore and analyze data related to Manhattan restaurants inspections. Users can filter inspection results by neighbourhood, cuisine types, and inspection grade, allowing for a tailored examination of the data. The app provides visualization of maps to display the distribution of inspection outcomes across different neighborhoods and time periods. This tool is valuable for both public health officials and the general public to monitor and understand restaurant compliance with health regulations in NYC Mahattan.
