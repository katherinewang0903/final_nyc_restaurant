...
data <- data %>%
  ...
  mutate(
    region = case_when(
      ...
      zipcode %in% c(10016, 10106, 10103, 10104, 10105, 10106, 10107, 10110, 10111, 10112, 10113, 10017, 10119, 10018, 10019, 10169, 10153, 10020, 10121, 10022, 10036, 10118, 10119, 10120, 10151) ~ "Midtown",
